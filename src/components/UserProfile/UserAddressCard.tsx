    ...
    <>
      ...
      <div className="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 shadow-sm hover:shadow-md transition-shadow duration-300">
        ...
        <div className="px-6 pt-6 pb-4 border-b border-gray-200 dark:border-gray-800">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={openModal}
              className="flex items-center gap-2 px-4 py-2.5 bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400 hover:bg-green-100 dark:hover:bg-green-900/30 rounded-lg font-medium text-sm transition-all duration-300 hover:scale-105"
            >
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {addressFields.map((field, index) => (
              <div key={index} className="bg-gray-50 dark:bg-gray-800/30 p-4 rounded-lg group hover:bg-gray-100 dark:hover:bg-gray-800/50 transition-colors">
          ...
          <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-800">
            <div className="flex flex-wrap items-center gap-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900 dark:text-white">Verified Address</p>
      ...
      <Modal isOpen={isOpen} onClose={closeModal} className="max-w-2xl">
        <div className="bg-white dark:bg-gray-900 rounded-2xl overflow-hidden">
          {/* Modal Header */}
          <div className="px-8 pt-8 pb-6 bg-gradient-to-r from-green-500/5 to-green-600/5 dark:from-green-900/10 dark:to-green-800/10">
            <div className="flex items-center justify-between">
              <div>
          ...
          <div className="p-8 max-h-[70vh] overflow-y-auto">
            <div className="space-y-6">
              ...
              <div className="p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                <h4 className="text-sm font-semibold text-gray-900 dark:text-white mb-3">Address Preview</h4>
          ...
          <div className="px-8 py-6 border-t border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-800/50">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                ...
                <Button 
                  onClick={handleSave}
                  className="px-6 py-2.5 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700"
                >
                  Save Address
                </Button>
              </div>
